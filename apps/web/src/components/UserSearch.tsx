    ...
    <div className="px-2 mt-auto border-t border-discord-tertiary pt-2 pb-2">
      ...
      <div className="flex gap-1 px-2">
        <input
          ...
          className="flex-1 bg-discord-input text-discord-text-primary text-sm rounded px-2 py-1 outline-none focus:ring-1 focus:ring-discord-accent placeholder-discord-text-muted min-w-0"
        />
        <button
