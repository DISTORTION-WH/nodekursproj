...
//     axios.get(`http://localhost:5000/users/${userId}`, config) // 👈 БЫЛО
    axios.get(`/users/${userId}`, config) // 👈 СТАЛО
      .then(res => {
        setUser(res.data);
...
//         "http://localhost:5000/chats/private", // 👈 БЫЛО
        "/chats/private", // 👈 СТАЛО
        { friendId },
        config
      );
...
    try {
      await axios.post(
//         `http://localhost:5000/friends/remove`, // 👈 БЫЛО
        `/friends/remove`, // 👈 СТАЛО
        { friendId: user.id },
        config
      );
